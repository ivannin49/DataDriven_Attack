...
df_id <- dplyr::select(df_objects,(1))
df_name <- dplyr::select(df_objects,(2))
df_source_url <- dplyr::select(df_objects,(5))
df_revoked <- dplyr::select(df_objects,(7))
df_type <- dplyr::select(df_objects,(8))
df_modified <- dplyr::select(df_objects,(9))
df_description <- dplyr::select(df_objects,(13))
df_x_mitre_version <- dplyr::select(df_objects,(15))
df_x_mitre_detection <- dplyr::select(df_objects,(17))

df_x_mitre_permission_required <- dplyr::select(df_objects,(18))
df_x_mitre_data_sources <- dplyr::select(df_objects,(19))
df_x_mitre_platform <- dplyr::select(df_objects,(20))
df_x_mitre_system_requirements <- dplyr::select(df_objects,(22))

df_tidy <- data.frame(df_id,df_name,df_source_url,df_revoked,df_type,df_modified,df_description,df_x_mitre_version,df_x_mitre_detection,df_x_mitre_permission_required,df_x_mitre_data_sources,df_x_mitre_platform,df_x_mitre_system_requirements)
